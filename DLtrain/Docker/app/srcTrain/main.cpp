...
// ./cpuTrain/bin/DLtrain -m train -s NewNetwork.dat 
//  -c network_prop.txt -n 2000 -e 3  -d /home/mistral/dev/C-Conv/Images
/////////
  //options[0] = true;

  //options[1] = true;
  //save_name.append("NewNetwork.dat");

  //options[2] = true;
  //config_name.append("network_prop.txt");

  //options[4] = true;
  //num_images = std::stoi("2000");
  //epochs = std::stoi("3");
