...
You can install components such as **Nucleus, Create, View** either:  
- From the **NVIDIA Omniverse Launcher**, or  
- Via direct `.deb` installers.  

---

VIDIA Omniverse Enterprise SDK & Nucleus
